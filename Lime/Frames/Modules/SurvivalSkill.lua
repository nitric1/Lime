...
local skills = {
	...
	-- 물약
	["POTION"] = {[SL(279152)] = L["lime_survival_민첩"], [SL(279153)] = L["lime_survival_힘"], [SL(279154)] = L["lime_survival_체력"], [SL(279151)] = L["lime_survival_지능"], [SL(269853)] = L["lime_survival_죽음"], [SL(251231)] = L["lime_survival_방어도"], [SL(251316)] = L["lime_survival_피"], [SL(252753)] = L["lime_survival_마나"], [SL(229206)] = L["lime_survival_힘"] --[[Legacy]] },
	-- 준 생존기
...
local function findSkill(unit, lookup)
	for spell, newText in pairs(lookup) do
		local name, _, _, _, _, endTime, _, _, _, spellId = LimeAura:UnitBuff(unit, spell) --- Legacy Code
		if name then
...
local function checkSkill(unit, class)
	...
	if not name and skills["SEMI"] and lime.db.units.showSurvivalSkillSub then 	--우선 순위 3등 (준 생존기)
