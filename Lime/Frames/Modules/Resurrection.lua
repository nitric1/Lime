...
function limeMember_HideResurrection(self, noHideCenterIcon)
...
function limeMember_OnUpdateResurrectionBar(self)
	if self.resurrectionBar.startTime then
		...
		limeMember_HideResurrection(self)
	end
end

function limeMember_UpdateResurrection(self)
	if (self.isGhost or self.isDead) and self.unit and UnitHasIncomingResurrection(self.unit) then
		...
		if not self.resurrectionBar.caster then
			limeMember_HideResurrection(self, true)
		end
	else
		limeMember_HideResurrection(self)
	end
