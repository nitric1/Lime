...
local function createFontFrame()
	if not menu then
		...
		menu.fontAttribute = LBO:CreateWidget("DropDown", menu, "attribute", "Font attribute.", hidden, nil, nil, function() return menu.attributeSet[menu.info.attribute or ""] or "None", menu.attributeList end, set, "attribute")
